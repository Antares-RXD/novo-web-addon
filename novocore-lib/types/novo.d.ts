...
import Output from "../lib/transaction/output.js";
...
export class Transaction {
  ...
  setInputScript(
    inputIndex: number,
    unlockScriptOrCallback: Script | Function
  ): this;

  setInputSequence(inputIndex: number, sequence: number): this;

  setOutput(outputIndex: number, outputOrcb: Output | Function): this;
  ...
  setLockTime(nLockTime: number): this;
  ...
  //the serialization of all input outpoints
  prevouts(): string;
}
