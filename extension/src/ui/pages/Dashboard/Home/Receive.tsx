    ...
    <Layout className="h-full">
      ...
      <Content style={{ backgroundColor: '#1C1919' }}>
        <div className="flex flex-col items-center gap-10 mx-auto mt-5 justify-evenly w-110">
          <div className="flex items-center px-2 text-2xl font-semibold h-13 w340">{t('Deposit')} Novo</div>
          ...
          <div className="flex flex-col items-center justify-center gap-5">
            ...
            <AddressBar />
            <span className="font-normal text-soft-white mt-2_5">{t('This address can only receive Novo')}</span>
          </div>
        </div>
      </Content>
      <FooterBackButton />
